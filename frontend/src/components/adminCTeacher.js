...
export default function CreateTeacher() {
    ...
    const handleSubmit = async (e) => {
        ...
        .then((res)=>{
            ...
            if(res.success===true)
            {
                setErrMsg('Teacher Created Successfully !!')
                setCourseName([]);
                setStudentAge('');
                setStudentName('');
                setPassword('');
    ...
    return (
        ...
        <h1 align='center'><b>Enter New Teacher Details</b></h1>
            <br />
            <form onSubmit={handleSubmit} className="form">
                ...
                />
                <br />
                <label for="studentAge">Teacher Age</label><br />
                <input type="text"
                    id="age"
                    name="age"
                ...
                <div>
                    <FormControl sx={{ m: 1, width: "100%" }}>
                        <InputLabel id="demo-multiple-checkbox-label">Select Courses To Be Taught</InputLabel>
                        <Select
                            ...
                            input={<OutlinedInput label="Select Courses To Be Taught" />}
